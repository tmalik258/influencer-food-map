    ...
    <div className={cn("space-y-2", className)} ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div
            className={cn(
              "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 absolute z-50 max-h-60 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border shadow-md top-full left-0 right-0 mt-1"
            )}
          >
            <div className="p-1">
              {loading && (
              ...
              {selectedTags.length > 0 && (
                <div className="border-b border-border mt-1 pt-1">
                  <div
                    className={cn(
                      "focus:bg-accent focus:text-accent-foreground relative flex w-full items-center gap-2 rounded-sm py-1.5 pr-2 pl-2 text-sm outline-hidden select-none hover:bg-destructive/10 hover:text-destructive cursor-pointer text-destructive"
                    )}
