...
export function ActiveJobsTable({
  ...
  if (error) {
    return (
      <Card className="glass-effect backdrop-blur-xl bg-white/80 border border-red-200/50 shadow-xl">
        ...
        <div className="space-y-4">
          {jobs.map((job) => {
            ...
            return (
              <div
                key={job.id}
                className="flex items-center justify-between p-4 bg-orange-50/50 border border-orange-200/50 rounded-lg"
              >
