...
import { RefreshCw, Activity, TrendingUp, Clock, AlertTriangle, CheckCircle, BarChart3, Trash2 } from "lucide-react";
...
function AnalyticsCard({ title, value, description, icon: Icon, trend }: {
  title: string;
  value: string | number;
  description: string;
